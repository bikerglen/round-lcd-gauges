...
SPISettings settings(TFT_SPI_SPEED, MSBFIRST, SPI_MODE0);
...
void InitTftHardware (void)
{
  ...
  SPI.begin (TFT_GCLK, 32, TFT_GDAT, -1);
  delay (50);
}
...
{ 
  ...
  else if(USE_HORIZONTAL==3)Write_Cmd_Data(0x88);
  else Write_Cmd_Data(0x78);
